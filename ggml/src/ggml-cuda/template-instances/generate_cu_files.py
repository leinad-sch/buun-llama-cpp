...
TYPES_MMQ = [
    "GGML_TYPE_Q1_0", "GGML_TYPE_Q2_0", "GGML_TYPE_Q2_0_G128",
...
# Turbo MMA fused kernel instances: turbo4_0 matched K/V at D=128 and D=256.
TURBO_TYPES = [
    ("GGML_TYPE_TURBO4_0", "GGML_TYPE_TURBO4_0"),
]
TURBO_HEAD_SIZES = [(128, 128), (256, 256)]

SOURCE_FATTN_MMA_TURBO_START = """// This file has been autogenerated by generate_cu_files.py, do not edit manually.
...
for ncols in [8, 16, 32, 64]:
    for ncols2 in [1, 2, 4, 8]:
        if ncols2 > ncols:
            continue
        ncols1 = ncols // ncols2
        for dkq, dv in TURBO_HEAD_SIZES:
            for type_k, type_v in TURBO_TYPES:
                with open(f"fattn-mma-turbo-instance-dkq{dkq}-ncols1_{ncols1}-ncols2_{ncols2}.cu", "w") as f:
                    f.write(SOURCE_FATTN_MMA_TURBO_START)
                    f.write(SOURCE_FATTN_MMA_TURBO_CASE.format(dkq=dkq, dv=dv, ncols1=ncols1, ncols2=ncols2, type_k=type_k, type_v=type_v))
