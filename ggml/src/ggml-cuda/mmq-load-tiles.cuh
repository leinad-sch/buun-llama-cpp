...
// Fork-owned Q2_0_G128 (group-128, 2-bit) MMQ load-tiles — re-ported onto upstream #24127
// config-table framework, mirroring ggml_cuda_mmq_load_tiles_q1_0. Q8_0 SRAM layout
// (expand-to-int8, MMQ_Q8_1_DS_LAYOUT_D4 vec-dot). Crumb-unpack inner logic byte-identical to the
// pre-refactor load_tiles_q2_0_g128.
