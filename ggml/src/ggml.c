...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q2_0_G128] = {
        .type_name                = "q2_0_g128",
        .blck_size                = QK2_0_G128,
        .type_size                = sizeof(block_q2_0_g128),
        .is_quantized             = true,
    ...
    [GGML_TYPE_TURBO8_0] = {
        .type_name                = "turbo8",
        .blck_size                = QK_TURBO8,
        .type_size                = sizeof(block_turbo8_0),
        .is_quantized             = true,
    ...
    [GGML_TYPE_TURBO1_TCQ] = {
        ...
        .type_size                = sizeof(block_turbo1_tcq),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo1_tcq,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbo1_tcq_ref,
    },
    [GGML_TYPE_Q2_K] = {
        .type_name                = "q2_K",
        .blck_size                = QK_K,
